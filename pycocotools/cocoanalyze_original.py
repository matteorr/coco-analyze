...
class COCOanalyze:
    ...
    def __init__(self, cocoGt, cocoDt, iouType='keypoints'):
        ...
        self.localization_matches = {} #matches
        self.ori_score_matches    = {}
        self.opt_score_matches    = {}
        self.bckgd_err_matches    = {} #false_pos_neg_matches
    ...
    def analyze(self, check_kpts=True, check_scores=True, check_bkgd=True):
        ...
        # the check_kpts analysis changed keypoints in the cocoEval _dts object
    ...
    def correct_keypoints(self):
        ...
        self.localization_matches['dts'] = dtMatches
        self.localization_matches['gts'] = gtMatches
    ...
    def correct_scores(self):
        ...
        self.ori_score_matches['dts'] = dtMatches
        self.ori_score_matches['gts'] = gtMatches
    ...
    def _find_kpt_errors(self):
        tic = time.time()
        print "Finding localization errors causing false positives..."
        zero_kpt_gts  = 0
        corrected_dts = []
    ...
    def summarize(self, makeplots=False, savedir=None, team_name=None):
        ...
        if self.params.check_bkgd:
            ps_mat_false_errors = self._summarize_bckgd_errors()
